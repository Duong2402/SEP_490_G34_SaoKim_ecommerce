...
namespace SaoKim_ecommerce_BE.Migrations
{
    ...
    [Migration("20251219141043_DatabaseUpdate8")]
    partial class DatabaseUpdate8
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SaoKim_ecommerce_BE.Entities.ChatBotEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int?>("ToolResultCount")
                        .HasColumnType("integer")
                        .HasColumnName("tool_result_count");
                    ...
                    b.ToTable("chat_bot_events");
                });

            modelBuilder.Entity("SaoKim_ecommerce_BE.Entities.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SaoKim_ecommerce_BE.Entities.ChatProductClick", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("chat_product_clicks");
                });

            modelBuilder.Entity("SaoKim_ecommerce_BE.Entities.ChatSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SaoKim_ecommerce_BE.Entities.InventoryStockSnapshot", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("InventoryStockSnapshots");
                });
            ...
            modelBuilder.Entity("SaoKim_ecommerce_BE.Entities.ChatBotEvent", b =>
                {
                    b.HasOne("SaoKim_ecommerce_BE.Entities.ChatSession", "Session")
                        .WithMany("Events")
