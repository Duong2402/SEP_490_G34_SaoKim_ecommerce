...
{
    public class ManagerReportsService : IManagerReportsService
    {
        private readonly SaoKimDBContext _db;

        public ManagerReportsService(SaoKimDBContext db)
        {
            _db = db;
        }

        public async Task<ManagerOverviewDto> GetOverviewAsync()
        {
